  ...
  return (
    <div class="relative overflow-x-auto max-h-100">
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-light-shadow-box dark:bg-dark-shadow-box dark:text-gray-400">
          <tr>
        ...
        <tbody>
          {data.map((item, index) => (
            <tr
              class="bg-white border-b dark:bg-dark-main dark:border-gray-700"
              key={index}
            >
              <th
                scope="row"
